...
public:
	...
	float x, y;
	int direction; 
	bool solid = true; //if something is solid, pass me not trough
	bool collideWithSolids = true; //sometimes we can pass true solid things
	bool active = true; //entity turned on or off
	std::string type = "entity"; //what type of entity is it? e.g hero, enemy, wall etc
